...
class RichTextX extends RichText {
  //
  RichTextX({
    Key? key,
  ...
  @override
  void updateRenderObject(BuildContext context, RenderParagraphX renderObject) {
    assert(textDirection != null || debugCheckHasDirectionality(context));
    renderObject
      ..text = text
      ..textAlign = textAlign
...
class RenderParagraphX extends RenderBox
  ...
  List<TextSelection> get selections => throw UnimplementedError();
}
