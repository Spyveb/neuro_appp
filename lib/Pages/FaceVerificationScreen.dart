...
class FaceVerificationScreen extends StatefulWidget {
  ...
  FaceVerificationScreen({Key? key, this.routeArgument}) : super(key: key);

  @override
  _FaceVerificationState createState() => _FaceVerificationState();
}

class _FaceVerificationState extends StateMVC<FaceVerificationScreen> {
  ...
  _FaceVerificationState() : super(VerificationController()) {
  ...
  _imgFromCamera() async {
    ...
    setState(() {
      ...
      Navigator.pushNamed(context, '/FrontIDVerification',
          ...
          children: [
            ...
            Container(
                ...
                child: Column(
                  children: [
                    Text(
                      "Is your face clearly visible and in the frame?",
                      style: TextStyle(
                          fontSize: getProportionalFontSizeMain(14),
                          fontFamily: 'poppins',
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            _con.sendData.type = "image";
                            _con.sendData.file =
                                this.widget.routeArgument!.file_frontphoto!;
                            _con.passSelfieVerification();
                            showPicker(context);
                          },
                          child: Container(
                            alignment: Alignment.center,
