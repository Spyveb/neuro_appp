...
class BackIDVerificationScreen extends StatefulWidget{
  RouteArgument? routeArgument;

  BackIDVerificationScreen({Key? key, this.routeArgument}) : super(key: key);

  @override
  _BackIDVerificationState createState() => _BackIDVerificationState();
}

class _BackIDVerificationState extends StateMVC<BackIDVerificationScreen>{
  ...
  _BackIDVerificationState() : super(VerificationController()) {
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            _con.sendData.type = "back_image";
                            _con.sendData.file =
                            this.widget.routeArgument!.file_frontphoto!;
                            _con.passBackIDVerification();
                          },
                          child: Container(
                            alignment: Alignment.center,
                            width: getProportionateScreenWidthMain(150),
