...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_inapp_purchase/flutter_inapp_purchase.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/multi_image_picker2/multi_image_picker2.framework"
